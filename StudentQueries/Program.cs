...
namespace StudentQueries
{
	class Program
	{
		static void CopyToDatabase(PolContext context)
		{
		...
		static void FilterAndOrder(PolContext context)
		{
		...
		static void Join(PolContext context)
		{
			var result = from s in context.Students
		...
		static void GroupByFirstLetter(PolContext context)
		{
			var result = from s in context.Students
		...
		{
			using (PolContext c = new PolContext())
			{
